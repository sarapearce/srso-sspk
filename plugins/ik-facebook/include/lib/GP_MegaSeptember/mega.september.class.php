					...
					<div id="mc_embed_signup">
						...
						<form action="https://goldplugins.com/atm/atm.php?u=403e206455845b3b4bd0c08dc&amp;id=a70177def0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							...
							<div class="customer_testimonial">
									...
									<p class="customer_testimonial_title"><strong><?php echo $testimonial['title']; ?></strong></p>
									“<?php echo $testimonial['body']; ?>”
									<p class="author">&mdash; <?php echo $testimonial['name']; ?></p>
							</div>
							<?php endif; ?>
						</form>
						<div class="gp_logo">
							<a href="https://goldplugins.com/?utm_source=<?php echo htmlentities( sanitize_title($plugin_name) ); ?>_coupon_box&utm_campaign=gp_logo" target="_blank">
								<img src="<?php echo plugins_url('assets/img/logo.png', __FILE__);?>" alt="Gold Plugins" />
							</a>
						</div>
					</div>		
					<p class="u_to_p"><a href="<?php echo htmlentities($upgrade_url); ?>">Upgrade to Pro</a> to remove banners like this one.</p>
