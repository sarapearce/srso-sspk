<?php
	require_once('CachedCurl.php');
	require_once('GP_CacheBox.php');
	require_once('BikeShed/bikeshed.php');
	...
	{
		//  look for the WP Social Pro or WP Social Pro plugins to be installed and activated
