...
class ikFacebookLikeButtonWidget extends WP_Widget
{
	function __construct(){
		...
		parent::__construct('ikFacebookLikeButtonWidget', 'WP Social Facebook Like Button', $widget_ops);
	}
	...
	function form($instance){
		...
		?>
			...
			<p><label for="<?php echo $this->get_field_id('page_id'); ?>">URL to Like (defaults to your Site URL): </label><input class="widefat" id="<?php echo $this->get_field_id('page_id'); ?>" name="<?php echo $this->get_field_name('page_id'); ?>" type="text" value="<?php echo esc_attr($page_id); ?>" /></p>
	...
	function widget($args, $instance){
		...
		echo do_shortcode("[ik_fb_like_button page_id='{$page_id}' height='{$height}' colorscheme='{$colorscheme}']");
