 ...
 */
add_filter( 'rwmb_meta_boxes', 'sspk_register_meta_boxes' );
/**
 * Register meta boxes
 *
 * Remember to change "sspk" to actual prefix in your project
 *
 * @param array $meta_boxes List of meta boxes
 *
 * @return array
 */
function sspk_register_meta_boxes( $meta_boxes ) {
	/**
